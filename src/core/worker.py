...
class Connector:
    ...
    def __init__(self, store: Store):
        ...
        self.finished = False
        self.connect_urls: typing.List[str] = store.connect_urls
    ...
    def get_connect_url(self):
        return random.choice(self.connect_urls)

    async def websocket_connection(self):
        while not self.finished:
            try:
                # each time on fail it will take new url from list of connected urls.
                self.websocket = await client.connect(self.get_connect_url(),
                                                      max_size=None,
        ...
        try:
            ...
            if action == "add_domain":
                ...
                if domain:
                    ...
                    instance, is_created = self.get_or_create_domain(domain, 600)
                    if is_created:
        ...
        try:
            ...
            while instance.status in [PENDING]:
                ...
                await self.store.producer_queue.put(
                    {
                        # TODO old ws style will be removed in future
