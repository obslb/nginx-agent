...
class NginxAgent:
    ...
    def setup(self, upstreams: typing.Union[None, typing.List], **kwargs):
        ...
        # systemd_config = os.path.join(self.systemd_work_dir, "nginx-agent.service")
        # self.create_config(
        #     path=systemd_config,
        #     template_name="template.nginx-agent.service", **{
...
class Bootstrap:
    ...
    def command_run(parser: argparse.ArgumentParser = None):
        try:
            ...
            connect_url: str = args.connect_url
            if not connect_url:
                connect_url = os.environ.get('agent_connect_url')
            ...
            options["connect_url"] = connect_url
